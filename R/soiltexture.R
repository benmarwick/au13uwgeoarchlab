# This file contains code from the R packages 'soiltexture' and 'GS2d'. 
# Listing these packages in 'depends' caused problems, so I've just pulled
# the code for the functions I use. 
